...
@push('scripts')
    ...
    <script>
        // The ID 'explanation' must match the ID of your textarea
        CKEDITOR.replace('explanation', {
    // Define a simple, custom toolbar
        toolbar: [
            { name: 'basicstyles', items: ['Bold', 'Italic', 'Underline', 'Strike'] },
            { name: 'paragraph', items: ['NumberedList', 'BulletedList', '-', 'Blockquote'] },
            { name: 'links', items: ['Link', 'Unlink'] },
            { name: 'styles', items: ['Format'] },
            { name: 'document', items: ['Source'] } // Allows viewing the HTML source code
        ],
        // You can also remove specific buttons from groups if needed
        removeButtons: 'Subscript,Superscript,Anchor,Image,Table'
    });
    </script>
@endpush
