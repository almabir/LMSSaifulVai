<div class="dashboard__sidebar-wrap">
    ...
    <nav class="dashboard__sidebar-menu">
        <ul class="list-wrap">
            ...
            {{-- ADDED: Become an Affiliate Link --}}
            @if(!userAuth()->is_affiliate)
            <li class="{{ Route::is('student.affiliate.apply') ? 'active' : '' }}">
                <a href="{{ route('student.affiliate.apply') }}">
                    <i class="fas fa-handshake"></i>{{ __('Become an Affiliate') }}</a>
            </li>
            @endif

            {{-- This can be added to your student dashboard sidebar navigation list --}}
            @if(userAuth()->is_affiliate)
            <li class="{{ Route::is('student.withdraw.index') ? 'active' : '' }}">
                <a href="{{ route('student.withdraw.index') }}">
                    <i class="fas fa-wallet"></i>
                    <span>{{ __('Affiliate Withdraw') }}</span>
                </a>
            </li>
            @endif
        </ul>
