...
@section('title', __('Withdraw Affiliate Commissions'))

@section('dashboard-contents')
    <div class="dashboard__content-wrap">
        <div class="dashboard__content-title">
            <h4 class="title">{{ __('Affiliate Withdrawals') }}</h4>
        </div>
    ...
    <div class="dashboard__content-wrap mt-4">
        <div class="dashboard__content-title">
            <h5 class="title">{{ __('Request a Withdrawal') }}</h5>
        </div>
        <div class="card">
            <div class="card-body">
