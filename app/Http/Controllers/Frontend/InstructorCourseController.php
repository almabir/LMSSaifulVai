...
class InstructorCourseController extends Controller
{
    ...
    function store(Request $request)
    {
        $rules = [
            ...
            'affiliate_commission_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'], // <-- ADDED: Validation rule
        ...
        if ($request->edit_mode == 0) $rules['slug'] = ['required', 'string', 'max:255', 'unique:courses,slug'];
        ...
        $course->affiliate_commission_percentage = $request->affiliate_commission_percentage ?? 0; // <-- ADDED: Save the value
