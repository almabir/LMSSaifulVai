...
use Str;
use App\Traits\Affiliate\HandlesAffiliateCommission; // <-- 1. This line is essential.

class PaymentController extends Controller
{
    use GetGlobalInformationTrait, MailSenderTrait, HandlesAffiliateCommission;
    ...
    //     // === ADDED: PROCESS AFFILIATE COMMISSION FOR BANK PAYMENT ===
...
public function pay_via_bank(BankInformationRequest $request)
    {
        ...
        // === MOVED: PROCESS AFFILIATE COMMISSION AFTER ORDER ITEMS ARE CREATED ===
    ...
    public function payment_addon_success($bankDetails = null)
    {
        ...
        // === PROCESS AFFILIATE COMMISSION HERE ===
        $hi = $this->processAffiliateCommission($order);
        // === END OF COMMISSION PROCESSING ===
        ...
        Session::forget([
            'after_success_url', 'after_faild_url', 'payable_amount', 'gateway_charge',
            'after_success_gateway', 'after_success_transaction', 'subscription_plan_id',
            'payable_with_charge', 'payable_currency', 'paid_amount', 'payment_details',
            'cart', 'coupon_code', 'offer_percentage', 'coupon_discount_amount', 'gateway_charge_in_usd'
        ]);
