...
trait PermissionsTrait
{
    ...
    public static array $socialPermission = [
     ...
     /**
     * ADDED: Permission for Database Backup Management.
     */
    public static array $databaseBackupPermission = [
        'group_name' => 'Database Backup',
        'permissions' => [
            'database.backup.management',
        ],
    ];

    //     public static array $affiliateRequestPermissions = [
    //     'group_name' => 'Affiliate Requests',
    //     'permissions' => [
    //         'affiliate.requests.view',
    //         'affiliate.requests.update',
    //     ],
    // ];

    // /**
    //  * ADDED: Permissions for Affiliate Dashboard.
    //  */
    // public static array $affiliateDashboardPermissions = [
    //     'group_name' => 'Affiliate Dashboard',
    //     'permissions' => [
    //         'affiliate.dashboard.view',
    //         'affiliate.commission.update',
    //     ],
    // ];

    //     /**
    //  * ADDED: Permissions for Affiliate Commissions Management.
    //  */
    // public static array $affiliateCommissionsPermissions = [
    //     'group_name' => 'Affiliate Commissions',
    //     'permissions' => [
    //         'affiliate.commissions.view',
    //         'affiliate.commissions.update',
    //     ],
    // ];

    // public static array $affiliateWithdrawalPermissions = [
    //     'group_name' => 'Affiliate Withdrawal',
    //     'permissions' => [
    //         'affiliate.withdrawal.view',
    //         'affiliate.withdrawal.update',
    //     ],
    // ];

    /**
     * ADDED: Permissions for Affiliate Requests Management.
     */
    public static array $affiliateRequestPermissions = [
        'group_name' => 'Affiliate Requests',
        'permissions' => [
    ...
    /**
     * ADDED: Permissions for Affiliate Withdrawal Management.
     */
    public static array $affiliateWithdrawalPermissions = [
        'group_name' => 'Affiliate Withdrawal',
        'permissions' => [
    ...
    /**
     * ADDED: Permissions for managing the withdrawal methods themselves.
     */
    public static array $affiliateWithdrawMethodPermissions = [
        'group_name' => 'Affiliate Withdraw Methods',
        'permissions' => [
            'affiliate-withdraw-methods.index',
            'affiliate-withdraw-methods.create',
            'affiliate-withdraw-methods.store',
            'affiliate-withdraw-methods.edit',
            'affiliate-withdraw-methods.update',
            'affiliate-withdraw-methods.destroy',
        ],
    ];
