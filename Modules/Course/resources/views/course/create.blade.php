                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="from-group mb-3">
                                                        <label class="form-file-manager-label" for="thumbnail">{{ __('Thumbnail') }}
                                                            <code>*</code></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="demo_video_storage" id="demo_video_storage" class="form-control">
                                                            <option @selected(@$course?->demo_video_storage == 'upload') value="upload">{{ __('upload') }}
                                                            </option>
                                                ...
                                                <div class="col-md-6 upload {{ @$course?->demo_video_storage == 'upload' ? '' : 'd-none' }}">
                                                    <div class="from-group mb-3">
                                                        <label class="form-file-manager-label" for="path">{{ __('Path') }}
                                                            <code></code></label>
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="basic-addon1">
                                                ...
                                                <div class="col-md-6 external_link {{ @$course?->demo_video_storage != 'upload' ? '' : 'd-none' }}">
                                                    <div class="form-grp">
                                                        <label for="external_path">{{ __('Path') }} <code></code></label>
                                                ...
                                                {{-- AFFILIATE COMMISSION FIELD INSERTED HERE --}}
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="affiliate_commission_percentage">{{ __('Affiliate Commission (%)') }}</label>
                                                        <input type="number" name="affiliate_commission_percentage" class="form-control" value="{{ @$course?->affiliate_commission_percentage ?? 0 }}" min="0" max="100" step="0.01">
                                                        <small class="form-text text-muted">{{ __('The percentage of the course price that will be awarded to an affiliate for a referred sale.') }}</small>
                                                    </div>
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function convertToSlug(text) {
                return text
                    .toLowerCase()
                    .replace(/[^a-z0-9\s-]/g, "") // Allow numbers as well
                    .replace(/\s+/g, "-") 
                    .replace(/-+/g, "-"); 
            }
        })
