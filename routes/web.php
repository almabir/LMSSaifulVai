...
Route::group(['middleware' => ['auth', 'verified'], 'prefix' => 'student', 'as' => 'student.'], function () {
    ...
    // Withdrawal Routes
    Route::get('withdraw', [AffWithdrawalController::class, 'index'])->name('withdraw.index');
    Route::post('withdraw', [AffWithdrawalController::class, 'store'])->name('withdraw.store');
});

Route::group(['middleware' => ['auth', 'verified']], function () {

    // Affiliate Link Generation Route
    Route::post('affiliate/generate-link/{courseId}', [AffiliateLinkController::class, 'generate'])->name('affiliate.link.generate');
...
Route::group(['middleware' => ['auth', 'verified'], 'prefix' => 'student', 'as' => 'student.'], function () {
    ...
    Route::get('affiliate/apply', [AffiliateController::class, 'index'])->name('affiliate.apply');
...
Route::group(['middleware' => 'maintenance.mode'], function () {
     ...
     * ============================================================================
     */
// Route::get('student/learning/quiz/{id}', [LearningController::class, 'quizIndex'])->name('student.quiz.index');
